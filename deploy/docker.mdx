...
Build the image and run a container with your knowledge directory mounted as a volume.
...
| 2. Go | `golang:1.25-alpine` | Compiles the Go binary with the UI embedded via `go:embed` |
