...
- **Web UI included** — wiki links, knowledge graph, Mermaid diagrams, markdown editing, Bases, canvas, whiteboard, comments, and dark mode.
- **Single binary, zero config** — download and run. No Node, no Docker required (Docker optional).
- **Fair Source** — [BSL 1.1](https://github.com/kiwifs/kiwifs/blob/main/LICENSE). Self-host and embed freely. Each release converts to Apache 2.0 after four years.
...
<CardGroup cols={2}>
  ...
  <Card title="Widgets" icon="puzzle-piece" href="/concepts/widgets">
    Charts, calc, steps, claims, and other rich blocks.
  </Card>
</CardGroup>
