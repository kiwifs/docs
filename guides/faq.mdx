...
3. **MCP** — `kiwifs mcp --root ~/knowledge` (71 tools)
</Accordion>
...
<Accordion title="Is KiwiFS open source?">
No. KiwiFS is **Fair Source** under [BSL 1.1](https://github.com/kiwifs/kiwifs/blob/main/LICENSE). The source is public and you can self-host, modify, and embed it. You cannot offer KiwiFS itself as a competing hosted service. Each release converts to Apache 2.0 four years later. See [fair.io](https://fair.io/licenses/).
</Accordion>
