...
KiwiFS can export your entire knowledge base (or a subset of it) as JSONL, CSV, or Parquet. You can export from the CLI or the REST API. For rendered documents (PDF, HTML, slides, static site), see [Document export](/export/documents).
...
<Tab title="Parquet">
Columnar export for data warehouses and analytics pipelines. Each row represents one file with frontmatter fields as columns.
