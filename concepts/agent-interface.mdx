...
21 tools: `kiwi_read`, `kiwi_write`, `kiwi_search`, `kiwi_tree`, `kiwi_query_meta`, `kiwi_query`, `kiwi_view_refresh`, `kiwi_delete`, `kiwi_rename`, `kiwi_bulk_write`, `kiwi_aggregate`, `kiwi_import`, `kiwi_export`, `kiwi_changes`, `kiwi_append`, `kiwi_search_semantic`, `kiwi_backlinks`, `kiwi_analytics`, `kiwi_memory_report`, `kiwi_context`, `kiwi_health_check`.
