...
description: "Connect Claude, Cursor, and other AI tools to KiwiFS — stdio, HTTP, and 60+ tools."
icon: "plug"
---
...
| `kiwi_canvas_generate` | Auto-layout from the wiki-link graph. |
</Accordion>
...
- REST counterparts: [Drafts](/api/drafts), [Views](/api/views), [Canvas](/api/canvas), [Workflows](/api/workflows), [Claims](/api/claims), [Utilities](/api/utilities), [Import and export](/api/import-export#import-browse).
