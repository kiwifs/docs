...
<Info>
Each successful read of a knowledge file records a page view for analytics. Pass `?source=mcp` or the `X-Kiwi-Source` header to attribute views to your client. Bot user agents are excluded. See [Analytics and health](/api/analytics#page-view-tracking).
</Info>
